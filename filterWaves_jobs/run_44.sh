...
#root -l -b -q 'filterWaves.C(44, 44+1, "waves_tran_44.root")'
root -l  '../filterWaves.C("/junofs/prototype/Data_prtJUNO/Raw_Data/ihep_test_data/test_20200825_120223HAM_0.05mHVBRASS60_NSPB50_pinghan_60ouxianSPE",44, 44+1, "waves_tran_44.root",true)'
popd
