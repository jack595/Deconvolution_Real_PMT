...
root -l -b -q '../filterWaves.C("/junofs/prototype/Data_prtJUNO/Raw_Data/ihep_test_data/test_20200704_174537_2mHV_0.1mHVCB_0.2mLEMO_Ham_2100V_75ohm",44, 44+1, "waves_tran_44.root")'
popd
